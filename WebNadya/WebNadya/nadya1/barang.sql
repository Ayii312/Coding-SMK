...
INSERT INTO `barang` (`kode_barang`, `nama`, `gambar`, `deskripsi`, `harga`, `jam`, `tanggal`) VALUES
...
(6, 'esp32', 'esp32.jpg', 'gitu deh', 90000, NULL, NULL);
...
--
ALTER TABLE `barang`
  MODIFY `kode_barang` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
