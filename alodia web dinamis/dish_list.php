...
// Hitung total data
$resCount    = $koneksi->query("SELECT COUNT(*) AS total FROM dish");
...
<p align="center">
  Tampilkan:
  <select onchange="window.location.href='index.php?page=dish_list&pagenum=1&limit=' + this.value;">
  ...
  <tbody>
    <?php if ($result->num_rows): 
      ...
      <tr>
        ...
        <td><?php echo $row['id_dish']; ?></td>
        <td>
          <img src="uploads/<?php echo htmlspecialchars($row['gambar_dish']); ?>" width="80" alt="">
        </td>
        <td>
          <a href="detail.php?id=<?php echo $row['id_dish']; ?>">
            <?php echo htmlspecialchars($row['nama_dish']); ?>
          </a>
        </td>
        ...
        <td>
          <a href="edit.php?id=<?php echo $row['id_dish']; ?>">Edit</a> |
...
<p align="center">
  <?php if ($totalPages > 1): ?>
    <?php if ($page > 1): ?>
      <a href="?page=dish_list&p=<?php echo $page-1; ?>&limit=<?php echo $limit; ?>">&laquo; Sebelumnya</a>
    <?php endif; ?>
    ...
    <?php for($i = 1; $i <= $totalPages; $i++): ?>
      ...
      <?php else: ?>
        <a href="?page=dish_list&p=<?php echo $i; ?>&limit=<?php echo $limit; ?>">
          <?php echo $i; ?>
        </a>
      <?php endif; ?>
    <?php endfor; ?>
    ...
    <?php if ($page < $totalPages): ?>
      <a href="?page=dish_list&p=<?php echo $page+1; ?>&limit=<?php echo $limit; ?>">
        Selanjutnya &raquo;
      </a>
    <?php endif; ?>
  <?php endif; ?>
